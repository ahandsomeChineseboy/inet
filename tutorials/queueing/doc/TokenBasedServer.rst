...
The packets are popped by a :ned:`TokenBasedServer` module. There are no token generators
in this network, but the server has 10 initial tokens to process packets.
